        ...
        <fieldset>
            ...
            <div class="form-group <? if($errors->has('code')) echo 'has-error' ?>">
                ...
                <div class="col-sm-6">
                    ...
                    @if($errors->has('code')) {{ $errors->first('code', '<span class="help-block">:message</span>') }} @endif
                </div>
            </div>
            ...
            <div class="form-group <? if($errors->has('password')) echo 'has-error' ?>">
                ...
                <div class="col-sm-6">
                    ...
                    @if($errors->has('password')) {{ $errors->first('password', '<span class="help-block">:message</span>') }} @endif
                </div>
            </div>
            ...
            <div class="form-group <? if($errors->has('password_confirmation')) echo 'has-error' ?>">
                <div class="col-sm-6 col-sm-offset-2">
                    ...
                    @if($errors->has('password_confirmation')) {{ $errors->first('password_confirmation', '<span class="help-block">:message</span>') }} @endif
                </div>
            </div>
