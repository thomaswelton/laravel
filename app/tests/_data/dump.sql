...
# Database: laravel
# Generation Time: 2013-11-17 20:21:10 +0000
# ************************************************************
...
VALUES
	...
	('2013_07_30_152236_migration_config',1),
	('2013_08_21_235421_migration_sessions',1),
	...
	('2013_11_17_044435_migration_cache',1);
...
CREATE TABLE `oauth_facebook` (
  ...
  CONSTRAINT `oauth_facebook_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



# Dump of table oauth_github
# ------------------------------------------------------------
...
CREATE TABLE `oauth_github` (
  ...
  CONSTRAINT `oauth_github_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `oauth_google` (
  ...
  CONSTRAINT `oauth_google_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



# Dump of table oauth_instagram
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oauth_instagram`;

CREATE TABLE `oauth_instagram` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `oauth_uid` text COLLATE utf8_unicode_ci NOT NULL,
  `access_token` text COLLATE utf8_unicode_ci NOT NULL,
  ...
  CONSTRAINT `oauth_instagram_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;



# Dump of table oauth_twitter
# ------------------------------------------------------------
...
CREATE TABLE `oauth_twitter` (
  ...
  CONSTRAINT `oauth_twitter_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
